...
const CHARACTER_PROFILES = {
  homeless: {
    image: RAW_BASE + encodeURIComponent('бомж поздравитель.jpg'),
  ...
  boss_baby: {
    image: RAW_BASE + encodeURIComponent('босс малокосос поздравитель.jpg'),
  ...
  young_woman: {
    image: RAW_BASE + encodeURIComponent('девушка поздравитель.jpg'),
  ...
  grandpa: {
    image: RAW_BASE + encodeURIComponent('дедушка поздравитель.jpg'),
  ...
  secret_agent: {
    image: RAW_BASE + encodeURIComponent('агент поздравитель.jpg'),
  ...
  tv_host: {
    image: RAW_BASE + encodeURIComponent('ведущий поздравитель.jpg'),
...
function detectCharacter(prompt) {
  ...
  if (text.includes('Персонаж: Бомж-поздравитель')) return 'homeless';
  if (text.includes('Персонаж: Босс-малокосос')) return 'boss_baby';
  if (text.includes('Персонаж: Молодая девушка')) return 'young_woman';
  if (text.includes('Персонаж: Старенький дедушка')) return 'grandpa';
  if (text.includes('Персонаж: Тайный агент')) return 'secret_agent';
  if (text.includes('Персонаж: Эстрадный ведущий')) return 'tv_host';
  return null;
}
...
function enrichCharacterTask(body, characterId) {
  ...
  body.input = {
    ...
    prompt: [
      profile.prompt,
      'Personalized recipient request:',
